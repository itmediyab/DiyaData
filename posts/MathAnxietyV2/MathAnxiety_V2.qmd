...
author: "Diya Bijoy, Swetha KV, Abhinav R, Aanya Pandith"
date: "2025-09-28"
...
Why is the count reducing in secondary grade?
...
```{r}
meth_modified %>%
  gf_boxplot(arith ~ grade | gender, fill = ~ grade, orientation = "x") %>%
  gf_labs(
    title = "Boxplot of Grade vs Arithmetic Score",
    subtitle = "Faceted by Gender, Colored by Grade",
    x = "Grade",
    y = "Arithmetic Score",
    color = "Grade"
